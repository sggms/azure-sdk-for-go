...
func Test_GetIndexedPackages(t *testing.T) {
	...
	pkgs := []string{
		"github.com/sggms/azure-sdk-for-go/services/authorization/mgmt/2015-07-01/authorization",
		"github.com/sggms/azure-sdk-for-go/services/classic/management",
		"github.com/sggms/azure-sdk-for-go/services/cognitiveservices/v2.0/luis/programmatic",
		"github.com/sggms/azure-sdk-for-go/services/operationalinsights/mgmt/2015-11-01-preview/operationalinsights",
		"github.com/sggms/azure-sdk-for-go/services/web/mgmt/2016-09-01/web",
	}
...
func Test_GetPackagesForIndexing(t *testing.T) {
	...
	// verify packages
	pkgs := []string{
		"github.com/sggms/azure-sdk-for-go/services/zed/mgmt/2017-06-01/zed",
		"github.com/sggms/azure-sdk-for-go/services/zed/v1.0/zeddp",
		"github.com/sggms/azure-sdk-for-go/services/bar/mgmt/2017-01-01/bar",
		"github.com/sggms/azure-sdk-for-go/services/foo/mgmt/2018-01-01/foo",
	}
	for _, pkg := range pkgs {
		if indexed, ok := ps[pkg]; !ok {
			t.Logf("didn't find package '%s'\n", pkg)
